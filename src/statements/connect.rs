...
//         types::Register,
//         vault::{self, VAULT_N},
//         vaultmod::{get_parent_path, get_salt},
//     },
// };
...
//         //
//         storage::vaultmod::is_parent_vault_exisits()?;
...
//         storage::vaultmod::validate_f_header(&child_p)?;
...
//         let parent_file_p = get_parent_path()?;
...
//         let mut salt = vault::Vault::get_child_salt(&p)?;
//         let mut nonce = vault::Vault::get_child_nonce(&p)?;
